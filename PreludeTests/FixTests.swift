...
//    let factorial = fix { (recur: @escaping (Int) -> Int) in
...
//			let next: () -> Fibonacci
//		}
//    let fibonacci: (Int, Int) -> Fibonacci = fix { (recur: @escaping ((Int, Int) -> Fibonacci) -> (Int, Int) -> Fibonacci) in
//			{ x, y in
//        return Fibonacci(value: x + y, next: { recur(y, x + y) })
//      }
//		}
